      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-sm font-bold text-amber-800">Javid Fighter Campaigns</span>
              <p className="text-xs text-amber-600">کمپین‌های ایمیلی جاوید فایتر</p>
            </div>
          </div>
        ...
        {!loading && campaigns.length === 0 && !error && (
          <div className="text-center py-12">
            <p className="text-neutral-400 text-sm">No internal campaigns right now.</p>
          </div>
        )}
        ...
        {campaigns.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-sm font-bold text-neutral-700 uppercase tracking-wide">Internal Campaigns</h2>
            </div>
